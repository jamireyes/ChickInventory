<?php
    ...
    include 'include/res_sql.php';
    include 'ReservationDataToFile.php';
    require 'table-modal.php';
?>
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row panel-body">
                        <button class="Add btn btn-primary" data-toggle="modal" data-target="#resStatModal" id="addNewResBtn">
                        <span class="fa fa-plus-square"></span> Add New Reservation
                        </button>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">Products</div>
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="resTable">
                                <thead>
                                    <tr>
    ...
    <script src="include/js/reservations_CRUD.js"></script>
